...
describe("port validation tests", () => {
    ...
    inputTest("will invalidate a port that is not a number", watcher.isValidPort(<any>"foo"), false);
...
describe("interval validation tests", () => {
    inputTest("will invalidate an interval that is not a number", watcher.isValidInterval(<any>"foo"), false);
